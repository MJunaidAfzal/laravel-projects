                    ...
                    <div style="background-color:lightgrey;" class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <label for=""><b>Name</b></label>
                             <input style="border: groove 3px darkred;" type="text" name="name" id="" class="p-4 form-control" value="{{old('name')}}">
                            <small class="text-danger">@error('name')  {{$message}} @enderror</small>
                            </div>
                            <div class="col-md-6">
                            <label for=""><b>Price</b></label>
                             <input style="border: groove 3px darkred;" type="text" name="price" id="" class="p-4 form-control" value="{{old('price')}}" >
                        ...
                        <div class="row">
                            ...
                            <label for=""><b>Year</b></label>
                             <input style="border: groove 3px darkred;" type="number" name="year" id="" class="p-4 form-control" value="{{old('year')}}" >
                            <small class="text-danger">@error('year')  {{$message}} @enderror</small>
                            </div>
                            <div class="col-md-6 mt-3">
                            <label for=""><b>Speed</b></label>
                             <input style="border: groove 3px darkred;" type="number" name="speed" id="" class="p-4 form-control" value="{{old('speed')}}" >
                        ...
                        <label for=""><b>Status</b></label>
                            <select class="form-control " style="border: groove 3px darkred;" name="status" id="" >
                                ...
                                <option value="1" @if(old("range") == 1) selected @endif>Active</option>
                                <option value="0" @if(old("range") == 0) selected @endif>Deactive</option>
                            </select>
